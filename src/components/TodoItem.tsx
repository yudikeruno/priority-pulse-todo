...
const TodoItem: React.FC<TodoItemProps> = ({ todo, onUpdate, onDelete, onEdit }) => {
  ...
  return (
    <div className={cn(
      "bg-white rounded-lg p-4 shadow-md hover:shadow-lg transition-all duration-200 border-l-4",
      isOverdue && !isCompleted && "border-l-red-500 bg-red-50",
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className={cn(
              ...
              todo.status === 'completed' && "bg-green-100 border-green-300 text-green-700 hover:bg-green-200"
            )}
          >
